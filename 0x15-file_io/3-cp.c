...
#define PERMISSIONS (S_IRUSR | S_TWUSR | S_IRGRP | S_TWGRP | S_IROTH)
...
if (ac != 3)
dprintf(STDERR_FILEDNO, USAGE),exit(97);
from_fd = open(av[1],O_RDONY);
if (from_fd == -1)
...
dprint(STDERR_FILENO, ERR_NOWRITE, ave[2], exit(99);
if (b == -1)
